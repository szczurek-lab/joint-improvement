"""
Source: https://github.com/schwallergroup/saturn/blob/master/oracles/docking/quickvina2.py
...
class DockingVina(object):
    def __init__(self, target):
        ...
        if not _OPENBABEL_AVAILABLE:
            raise ImportError(
                "OpenBabel (pybel) is required for docking calculation. "
        ...
        # Set paths relative to module directory
        self.vina_program = str(module_dir / 'qvina02')
        self.receptor_file = str(module_dir / f'{target}.pdbqt')
