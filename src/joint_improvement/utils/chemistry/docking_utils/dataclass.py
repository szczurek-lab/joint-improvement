"""
Data classes for oracle component parameters.

Source: https://github.com/schwallergroup/saturn/blob/master/oracles/dataclass.py
"""
...
class OracleComponentParameters:
    name: str
    # reward_shaping_function_parameters is a dict that gets unpacked into RewardShapingFunctionParameters
    reward_shaping_function_parameters: Dict[str, Any]
    weight: float = 1.0
